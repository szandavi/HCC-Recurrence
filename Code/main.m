...
for j = 1:1
    ...
    list_All_features = {'INR','Satellite','Sex','No_Lesions',...
        'Cirrhosis','Bilirubin',...
        'LiverDisease','Size','PlateletCount',...
        'Hypertension','MetabolicRiskFactors','eGFR',...
        'Albumin','LVI','Hypercholesterolemia','CVS',...
        'PriorTACE','BMI','IHD','Age','ALT','HPVG','Ethnicity',...
        'DM','AFP'};
    ...
    XX_ML = T_X_ML_Sel;
    %%
    % MetabolicRiskFactors > 2 ; numberOfLesions >=2, eGFR>=90, ALT > 50,
